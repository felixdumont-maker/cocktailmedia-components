// @ts-nocheck
class RosesInclus extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--roses:#d4728c;--roses-pale:rgba(212,114,140,.1);--gris:#8a8580;--gris-clair:#c4beb6;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--creme);color:var(--noir)}
        .inclus-section{max-width:900px;margin:0 auto;padding:4rem 2rem}
        .inclus-header{text-align:center;margin-bottom:3rem}
        .inclus-label{font-family:'Bebas Neue',sans-serif;font-size:.7rem;letter-spacing:.4em;color:var(--roses);margin-bottom:.8rem}
        ...
        .inclus-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:var(--roses);transform:scaleX(0);transform-origin:left;transition:transform .3s ease}
        .inclus-card:hover::before{transform:scaleX(1)}
        .inclus-card:hover{transform:translateY(-4px);box-shadow:0 8px 30px rgba(212,114,140,.08)}
        .card-icon{font-size:1.6rem;margin-bottom:1rem;display:flex;align-items:center;justify-content:center;width:52px;height:52px;border-radius:50%;background:var(--roses-pale);margin-left:auto;margin-right:auto;transition:all .3s ease}
        .inclus-card:hover .card-icon{background:var(--roses);transform:scale(1.08)}
        .inclus-card:hover .card-icon svg{stroke:white}
        .card-icon svg{width:22px;height:22px;fill:none;stroke:var(--roses);stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;transition:stroke .3s ease}
      ...
      <section class="inclus-section">
        <div class="inclus-header">
          ...
          <p class="inclus-subtitle">Chaque service graphique comprend ces \u00e9l\u00e9ments. Rien de cach\u00e9, tout est transparent.</p>
        </div>
        <div class="inclus-grid">
          <div class="inclus-card"><div class="card-icon"><svg viewBox="0 0 24 24"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/></svg></div><h3 class="card-title">DESIGN SUR MESURE</h3><p class="card-desc">Aucun template. Chaque cr\u00e9ation est pens\u00e9e et con\u00e7ue sp\u00e9cifiquement pour toi.</p></div>
          <div class="inclus-card"><div class="card-icon"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg></div><h3 class="card-title">FICHIERS SOURCES</h3><p class="card-desc">Tu re\u00e7ois les fichiers modifiables (AI, PSD, PDF) en plus des formats finaux.</p></div>
          <div class="inclus-card"><div class="card-icon"><svg viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></div><h3 class="card-title">FORMATS WEB + PRINT</h3><p class="card-desc">Versions optimis\u00e9es pour le web (PNG, JPG) et l\u2019impression (PDF haute r\u00e9solution).</p></div>
...
customElements.define('roses-inclus', RosesInclus);
