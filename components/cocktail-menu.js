    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .cat-logo{height:60px;width:auto;object-fit:contain;margin-bottom:1rem;transition:transform .4s ease;filter:brightness(0) invert(1);opacity:.85}
        .cat:hover .cat-logo{transform:scale(1.1) rotate(-5deg);opacity:1}
        ...
        @media(max-width:640px){.menu-grid{grid-template-columns:1fr 1fr}.menu-section{padding:3rem 1.5rem}.cat{padding:2rem 1rem}.cat-logo{height:45px}}
