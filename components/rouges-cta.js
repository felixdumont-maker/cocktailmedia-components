    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--rouges:#8a2020;--gris:#8a8580;--gris-clair:#c4beb6;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--noir);color:var(--fond);position:relative;overflow:hidden}
      ...
      <section class="cta-section">
        ...
        <p class="cta-label">PR\u00caT POUR LA S\u00c9ANCE ?</p>
        ...
        <a href="https://www.cocktailmedia.ca/menu/depos" class="cta-btn" target="_top">R\u00c9SERVER UN APPEL <img src="https://static.wixstatic.com/shapes/603d87_26a759fec56b434d996293b5902ea3e7.svg" alt="" class="cta-btn-coupe"></a>
