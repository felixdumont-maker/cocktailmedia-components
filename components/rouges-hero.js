// @ts-nocheck
class RougesHero extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--rouges:#8a2020;--gris:#8a8580;--gris-clair:#c4beb6;--neg-color:#d5cec4;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased}
        ...
        .bg-word{position:absolute;font-family:'Bebas Neue',sans-serif;letter-spacing:.04em;color:var(--neg-color);text-decoration:line-through;text-decoration-color:var(--rouges);opacity:0;z-index:1;pointer-events:none;white-space:nowrap;user-select:none}
        ...
        .hero-label{font-family:'Bebas Neue',sans-serif;font-size:.75rem;letter-spacing:.4em;color:var(--rouges);position:relative;z-index:5;margin-bottom:.8rem;opacity:0;animation:fadeUp .6s ease-out .8s forwards}
        ...
        .hero-title .accent{color:var(--rouges)}
        ...
        .hero-divider{width:60px;height:3px;background:linear-gradient(90deg,var(--rouges),rgba(138,32,32,.3));border:none;position:relative;z-index:5;opacity:0;animation:fadeUp .6s ease-out 1.7s forwards}
      ...
      <section class="hero">
        <div class="hero-body">
          <span class="bg-word bg-w1" aria-hidden="true">BANALE</span>
          <span class="bg-word bg-w2" aria-hidden="true">G\u00c9N\u00c9RIQUE</span>
          <img src="https://static.wixstatic.com/shapes/603d87_26a759fec56b434d996293b5902ea3e7.svg" alt="" class="hero-logo">
          <p class="hero-label">COCKTAIL M\u00c9DIA</p>
          <h1 class="hero-title">LES <span class="accent">ROUGES</span></h1>
          <p class="hero-type">PHOTOGRAPHIE</p>
          <p class="hero-subtitle">Des photos professionnelles qui mettent en valeur ton entreprise. <strong>Produits, portraits, \u00e9v\u00e8nements, immobilier, drone</strong> \u2014 on couvre tout.</p>
          <hr class="hero-divider">
          <p class="hero-price">\u00c0 PARTIR DE 50$</p>
        </div>
      </section>`;
  }
}
customElements.define('rouges-hero', RougesHero);
