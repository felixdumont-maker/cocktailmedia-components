// @ts-nocheck
class DigestifsHero extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--digestifs:#e8731a;--gris:#8a8580;--gris-clair:#c4beb6;--neg-color:#d5cec4;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased}
        ...
        .bg-word{position:absolute;font-family:'Bebas Neue',sans-serif;letter-spacing:.04em;color:var(--neg-color);text-decoration:line-through;text-decoration-color:var(--digestifs);opacity:0;z-index:1;pointer-events:none;white-space:nowrap;user-select:none}
        ...
        .hero-label{font-family:'Bebas Neue',sans-serif;font-size:.75rem;letter-spacing:.4em;color:var(--digestifs);position:relative;z-index:5;margin-bottom:.8rem;opacity:0;animation:fadeUp .6s ease-out .8s forwards}
        ...
        .hero-title .accent{color:var(--digestifs)}
        ...
        .hero-divider{width:60px;height:3px;background:linear-gradient(90deg,var(--digestifs),rgba(232,115,26,.3));border:none;position:relative;z-index:5;opacity:0;animation:fadeUp .6s ease-out 1.7s forwards}
        ...
        .hero-note{font-size:.72rem;font-style:italic;color:var(--gris-clair);margin-top:.5rem;position:relative;z-index:5;opacity:0;animation:fadeIn .8s ease-out 2.1s forwards}
      ...
      <section class="hero">
        <div class="hero-body">
          <span class="bg-word bg-w1" aria-hidden="true">INVISIBLE</span>
          <span class="bg-word bg-w2" aria-hidden="true">D\u00c9PASS\u00c9</span>
          <img src="https://static.wixstatic.com/shapes/603d87_2841476480cb44b48a46eb7ffe2c32bc.svg" alt="" class="hero-logo">
          <p class="hero-label">COCKTAIL M\u00c9DIA</p>
          <h1 class="hero-title">LES <span class="accent">DIGESTIFS</span></h1>
          <p class="hero-type">SITE WEB</p>
          <p class="hero-subtitle">Un site web simple, efficace et professionnel pour ta PME. <strong>Site vitrine, boutique en ligne, refonte</strong> \u2014 cl\u00e9 en main.</p>
          <hr class="hero-divider">
          <p class="hero-price">\u00c0 PARTIR DE 150$</p>
          <p class="hero-note">Les prix excluent les frais d\u2019h\u00e9bergement.</p>
        </div>
      </section>`;
  }
}
customElements.define('digestifs-hero', DigestifsHero);
