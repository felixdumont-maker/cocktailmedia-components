// @ts-nocheck
class AperoCta extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--apero:#4a8c5c;--gris:#8a8580;--gris-clair:#c4beb6;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--noir);color:var(--fond);position:relative;overflow:hidden}
        ...
        .cta-label{font-family:'Bebas Neue',sans-serif;font-size:.7rem;letter-spacing:.4em;color:var(--apero);margin-bottom:.8rem}
        ...
        .cta-btn{display:inline-flex;align-items:center;gap:.6rem;font-family:'Bebas Neue',sans-serif;font-size:1.1rem;letter-spacing:.14em;color:white;background:var(--apero);padding:.9rem 2.5rem;border-radius:100px;text-decoration:none;transition:all .3s ease}
        .cta-btn:hover{background:var(--creme);color:var(--noir);transform:translateY(-3px);box-shadow:0 10px 30px rgba(74,140,92,.25)}
        .cta-btn-coupe{height:18px;transition:all .3s ease;filter:brightness(0) invert(1)}
        ...
        .cta-secondary:hover{color:var(--apero)}
        ...
        .cta-back:hover{color:var(--apero)}
      ...
      <section class="cta-section">
        <img src="https://static.wixstatic.com/shapes/603d87_30652102cab24c9e83d9405fe124ee69.svg" alt="" class="cta-logo" aria-hidden="true">
        <p class="cta-label">UN DOCUMENT \u00c0 PR\u00c9PARER ?</p>
        <h2 class="cta-title">ON EN JASE 15 MINUTES</h2>
        <p class="cta-subtitle">Pas de pitch, pas de pression. Tu nous expliques ton besoin, on te dit exactement ce qu\u2019on peut faire.</p>
        <a href="https://www.cocktailmedia.ca/menu/depos" class="cta-btn" target="_top">R\u00c9SERVER UN APPEL <img src="https://static.wixstatic.com/shapes/603d87_30652102cab24c9e83d9405fe124ee69.svg" alt="" class="cta-btn-coupe"></a>
...
customElements.define('apero-cta', AperoCta);
