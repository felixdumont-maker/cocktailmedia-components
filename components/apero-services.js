// @ts-nocheck
class AperoServices extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--fond:#FAF9F6;--noir:#2B2B2B;--apero:#4a8c5c;--apero-bg:rgba(74,140,92,.06);--gris:#8a8580;--gris-clair:#c4beb6;--ligne:rgba(43,43,43,.08);font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--fond);color:var(--noir)}
        ...
        .section-header::after{content:'';position:absolute;bottom:-3px;left:0;width:60px;height:3px;background:var(--apero)}
        .section-icon{height:36px;width:auto;object-fit:contain;flex-shrink:0}
        .section-header-info{flex:1}
        .section-label{font-family:'Bebas Neue',sans-serif;font-size:.65rem;letter-spacing:.3em;color:var(--apero);margin-bottom:.2rem}
        ...
        .service:hover{padding-left:.6rem;background:linear-gradient(90deg,var(--apero-bg),transparent)}
        .service-name{font-size:.9rem;font-weight:500;flex-shrink:0;transition:color .2s ease}
        .service:hover .service-name{color:var(--apero)}
        ...
        .service:hover .service-price{color:var(--apero)}
        ...
        .service:hover .service-arrow{opacity:1;transform:translateX(0);color:var(--apero)}
      ...
      <section class="services-section">
        <div class="section-header">
          <img src="https://static.wixstatic.com/shapes/603d87_30652102cab24c9e83d9405fe124ee69.svg" alt="" class="section-icon">
          <div class="section-header-info">
            <p class="section-label">NOS SERVICES</p>
            <h2 class="section-title">INFOGRAPHIE \u00c0 LA CARTE</h2>
          </div>
        </div>
        <a href="https://www.cocktailmedia.ca/menu/apero/toastvisuel" class="service" target="_top"><div class="service-left"><span class="service-name">Pr\u00e9sentation Powerpoint</span><span class="service-desc">Design professionnel de pr\u00e9sentation, mise en page soign\u00e9e et coh\u00e9rente</span></div><span class="service-dots"></span><span class="service-price">100,00$</span><span class="service-arrow">\u2192</span></a>
        <a href="https://www.cocktailmedia.ca/menu/apero/plan-signature" class="service" target="_top"><div class="service-left"><span class="service-name">Cr\u00e9ation de plan d\u2019affaires</span><span class="service-desc">Document structur\u00e9, visuel et pr\u00eat \u00e0 pr\u00e9senter aux investisseurs</span></div><span class="service-dots"></span><span class="service-price">200,00$</span><span class="service-arrow">\u2192</span></a>
      </section>`;
  }
}
customElements.define('apero-services', AperoServices);
