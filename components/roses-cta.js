// @ts-nocheck
class RosesCta extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :host{display:block;--creme:#FFF4E9;--fond:#FAF9F6;--noir:#2B2B2B;--roses:#d4728c;--gris:#8a8580;--gris-clair:#c4beb6;font-family:'Montserrat',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:var(--noir);color:var(--fond);position:relative;overflow:hidden}
        ...
        .cta-label{font-family:'Bebas Neue',sans-serif;font-size:.7rem;letter-spacing:.4em;color:var(--roses);margin-bottom:.8rem}
        ...
        .cta-btn{display:inline-flex;align-items:center;gap:.6rem;font-family:'Bebas Neue',sans-serif;font-size:1.1rem;letter-spacing:.14em;color:var(--noir);background:var(--roses);padding:.9rem 2.5rem;border-radius:100px;text-decoration:none;transition:all .3s ease}
        .cta-btn:hover{background:var(--creme);transform:translateY(-3px);box-shadow:0 10px 30px rgba(212,114,140,.25)}
        ...
        .cta-secondary:hover{color:var(--roses)}
        ...
        .cta-back:hover{color:var(--roses)}
      ...
      <section class="cta-section">
        <img src="https://static.wixstatic.com/shapes/603d87_a748d18eac8848e2b12f2731acfeaeb1.svg" alt="" class="cta-logo" aria-hidden="true">
        <p class="cta-label">UN PROJET GRAPHIQUE EN T\u00caTE ?</p>
        ...
        <a href="https://www.cocktailmedia.ca/menu/depos" class="cta-btn" target="_top">R\u00c9SERVER UN APPEL <img src="https://static.wixstatic.com/shapes/603d87_a748d18eac8848e2b12f2731acfeaeb1.svg" alt="" class="cta-btn-coupe"></a>
...
customElements.define('roses-cta', RosesCta);
